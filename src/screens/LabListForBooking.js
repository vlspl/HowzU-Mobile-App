...
export default class LabListForBooking extends Component {
  constructor(props) {
    super(props);
    ...
    try {
      ...
      if (response.data.Status) {
        ...
        response.data.LabList.map((item) => {
          ...
          // console.log('totaltestprices ======', totaltestprices);
          // console.log('totaltestprices ======', totaltestnames);
  ...
  OpenBookAppointment = (index) => {
    ...
    // });
    this.props.navigation.navigate("TestListForBooking", {
      labinfo: labinfo,
      from: "manually",
    });
  };
