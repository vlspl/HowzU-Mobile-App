...
export default class RePayBookingAmount extends Component {
  webview = null;
  constructor(props) {
    super(props);
    this.state = {
  ...
  backAction = () => {
    Alert.alert("Payment !", "Are you sure you want to cancel the payment?", [
      {
        text: "No",
        onPress: () => {
          null;
  ...
  handleWebViewNavigationStateChange = (newNavState) => {
    ...
    if (
      ...
      newNavState.url ==
        "https://visionarylifescience.com/AtomPaymentFail.aspx" &&
      ...
      Alert.alert("Payment  Failed !", "Do you  want to try again?", [
        {
          text: "No",
          onPress: () =>
            // this.props.navigation.replace('CheckStatus', {
            //   bookingid: bookingid,
            //   from: 'BookAppointment',
            // }),
            this.props.navigation.dispatch(
      ...
      <Container>
        ...
        {this.state.isError == true && (
          <Modal isVisible={this.state.isError}>
            ...
            >
              {Alert.alert("Internal Error !", "Chek the Booking status", [
                {
                  text: "Ok",
                  onPress: () =>
                    // this.props.navigation.reset('CheckStatus', {
                    //   bookingid: bookingid,
                    //   from: 'BookAppointment',
                    // }),
                    // this.props.navigation.replace('CheckStatus', {
