...
const RescheduleAppointCard = (props) => (
  <View style={{ flex: 1, flexDirection: "column", backgroundColor: "white" }}>
    ...
    >
      <Text style={{ flex: 1, fontSize: 13, color: "#3f3f3f" }}>
        {props.testbookat}
      </Text>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.container_text}>
        ...
        <View style={styles.emailsubview}>
          ...
          >
            <Text style={styles.email}>{props.testname}</Text>
          </View>
          ...
          <View style={styles.sharebtnview}>
            ...
            >
              <Text style={styles.suggestbtnTitle}>Reschedule</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
...
export default RescheduleAppointCard;
