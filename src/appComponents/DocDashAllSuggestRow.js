...
const DocDashAllSuggestRow = (props) => (
        ...
        <View style={styles.container_text}>
          ...
          <View style={styles.Mobilesubview}>
            <TouchableOpacity style={styles.touchable}>
              {/* <Image source={props.lablogo} style={styles.Iconcall} /> */}
              <ImageLoad
                placeholderSource={require('../../icons/lab-1.png')}
                source={{ uri: Constants.LAB_LOGO + props.lablogo }}
                style={styles.Iconcall}
                placeholderStyle={styles.Iconcall}
                borderRadius={34}
              />
            </TouchableOpacity>
          ...
          <View style={styles.emailsubview}>
            ...
            >
              <TouchableOpacity style={styles.touchable}>
                <Image
                  source={require('../../icons/Book-Test-2.png')}
...
export default DocDashAllSuggestRow;
